...
export default function SetupClerkAdminPage() {
  ...
  const setupAdmin = async () => {
    setIsLoading(true);
    try {
      const response = await fetch('/api/admin/create-clerk-admin');
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="max-w-md w-full p-8 bg-white rounded-lg shadow-md">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold">Setup Clerk Admin</h1>
        ...
        <div className="space-y-6">
          ...
          >
            {isLoading ? 'Setting up...' : 'Setup Super Admin in Clerk'}
          </button>
